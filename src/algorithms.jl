...
struct Groundstate_iDTEBD <: AbstractAlgorithm
    ...
    function Groundstate_iDTEBD(trunc_tol::Float64, convtol::Float64, maxiter::Int, verbosity::Int, timer_output::TimerOutput, finalizer::Finalizer)
        return new(trunc_tol, convtol, maxiter, verbosity, timer_output, finalizer)
    end
end


struct Groundstate_TDVP <: AbstractAlgorithm
    convtol::Float64
    maxD::Int
    maxiter::Int
    verbosity::Int
    ...
    function Groundstate_TDVP(convtol::Float64, maxD::Int, maxiter::Int, verbosity::Int, timer_output::TimerOutput, finalizer::Finalizer)
        return new(convtol, maxD, maxiter, verbosity, timer_output, finalizer)
    end
end