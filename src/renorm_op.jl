function construct_renormalisation(ρ::InfiniteDisorderDensityMatrix, H::DisorderMPOHam, dβ::Real, trunc_method::MatrixAlgebraKit.TruncationStrategy)
    ...
    Wtrunc, _, _, ϵ = truncate_mpo(W, trunc_method)
